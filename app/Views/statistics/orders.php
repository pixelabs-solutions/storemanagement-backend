                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img src="assets/dist/img/revenue.png" height="50px;" width="50px;"
                                            style="background-color:white; padding:10px; border-radius:10px;">
                                        <h3 class="mt-3"><?php echo $orders_stats["totalRevenue"]; ?> <?php echo $orders_stats['current_currency']; ?></h3>
                            ...
                            <div class=" align-items-center" style="background-color:#F2F2F2; border-radius:20px;">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img src="assets/dist/img/revenue.png" height="50px;" width="50px;"
                                            style="background-color:white; padding:10px; border-radius:10px;">
                                        <h3 class="mt-3"><?php echo $orders_stats["orderAverage"]; ?> <?php echo $orders_stats['current_currency']; ?></h3>
...
async function fetchAndFormatData() {
    ...
    const response = await fetch(`http://storemanagement.test/statistics/orders?query=${queryParamsForGraph}&is_rest=true`);
    ...
    dates.forEach(date => {
        ...
        dynamicData.averageItems.push(data.averageItems.byDate[date] || 0);
        dynamicData.totalCustomers.push(data.totalCustomers.byDate[date] || 0);
    });
