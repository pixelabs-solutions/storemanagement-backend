...
<!-- <style>
  ...
  .sms_customers_m .card-x {
    background-color: transparent;
    box-shadow: none;
    border: none;
  }

  .sms_customers_m_row_container {
    display: flex;
    align-items: center;
    gap: 5px;
  ...
  @media screen and (max-width: 945px) {
    ...
    .sms_feature_m_table_body {
      width: 900px;
    }

    .sms_customers_m .t_cusName_m {
      width: 310px;
    }

    .sms_customers_m .t_dolo_m {
      width: 240px;
    }

    .sms_customers_m .t_maddress_m {
      width: 180px;
    }

    .sms_customers_m .t_nOrders_m {
      width: 110px;
    }

    .sms_customers_m .t_oravg_m {
      width: 310px;
    }

    .sms_customers_m .t_total_m {
      width: 310px;
    }
  }
</style> -->
...
<!-- <style>
  ...
  .sms_customers_m_row_checkbox {
    width: 20px;
    height: 20px;
  }

  .sms_customers_m_status.sms_customers_m_cancelled {
  ...
  .sms_customers_m_status.sms_customers_m_approved {
