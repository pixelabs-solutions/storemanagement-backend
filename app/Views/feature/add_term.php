...
<div class="page-body">
    <div class="container-xl">
        <div class="row justify-content-center">
            <div class="col-12 col-md-12">
                    ...
                    <form class="card-body">
                        ...
                        <div class="row gx-3">
                            <div class="col-md-6 mb-3">
                                <label for="example-text-input" class="form-label" data-i18n="popoups.future_managment.edit_variation_in_product_managment.btn_addiotainal_term">the
                                    name of the term</label>
                                <input type="text" class="form-control rounded-3 p-3" id="sms_term_name" style="background-color: #EAEAEA" placeholder="Pink">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="example-select" class="form-label">associated feature </label>
                                <!--surround the select box with a "custom-select" DIV element. Remember to set the width:-->
                                <div class="sms_mu_bg_div rounded-2">
                                    <select class="form-select form-select-md h-100 bg-transparent" id="sms_feature_select">
                            ...
                            <div class="rounded-4">
                                <div class="col-12 col-md-12 rounded-2" id="sms_a_add_new_term">
                                    ...
                                    <div class="p-2">
                                        ...
                                        <div class='gx-3' id="colorPickerDiv">
                                            <div class="">
                                                <div class="mb-3 p-2 col-12 rounded-3 d-flex align-items-center justify-content-between " style="background-color: #EAEAEA">
                                                    ...
                                                    <input type="color" class="form-control p-0 form-control-color" id="sms_mu_color_name_term" value="#206bc4" title="Choose your color">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label">
                                                ...
                                                <div class="sms_a_add_term_input">
                                                    <input type="file" id="sms_term_image" accept="image/*" style="background-color:#FFFFFF;" onchange="sms_a_add_term_showFileName(this)">
                                ...
                                <div class="text-center mt-2 p-2  ">
                                    <button type="button" onclick="sms_a_add_new_term_input()" class="btn btn-primary col-12 col-md-12 rounded-4 py-3">To add
                                        another term click here +</button>
                                </div>
                                <div class="text-center mt-2 p-2  ">
                                    <button type="button" class="btn btn-danger col-12 col-md-12 rounded-4 py-3" onclick="submit_add_term()">this is
                                        submit button</button>
                                </div>
                            </div>
                        </div>
                    </form>
                    <div class="modal-body text-center py-4 sms_term_pop" id="sms_term_success-message" style="display: none;">
                    <!-- SVG icon -->
                ...
                <div class="modal-body text-center py-4 sms_term_pop" id="sms_term_error-message" style="display: none;">
                    <!-- SVG icon -->
    ...
    <script>
        ...
        <div class="gx-3">
            ...
            <div class='gx-3' id="colorPickerDiv">
            <div class='gx-3' id="colorPickerDiv__P">
                                    <div class="">
                                        <div class="mb-3 p-2 col-12 rounded-3 d-flex align-items-center justify-content-between " style="background-color: #EAEAEA">
                                            <label class="form-label"></label>
                                            <label class="form-label">Color change</label>
                                            <input type="color" class="form-control p-0 form-control-color" id="sms_mu_color_name_term__P" value="#206bc4" title="Choose your color">
                                        </div>
                                    </div>
                                </div>
    ...
    `;
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var colorInput = document.getElementById("sms_mu_color_name_term");
        ...
        document.addEventListener("DOMContentLoaded", function() {
            // Get the color input element
            var colorInput = document.getElementById("sms_mu_color_name_term__P");
            // Get the div to trigger color selection
            var colorPickerDiv = document.getElementById("colorPickerDiv__P");
        ...
        function submit_add_term() {
            ...
            let colorInput = document.getElementById('sms_mu_color_name_term').value.trim();
