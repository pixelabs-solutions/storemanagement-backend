                    ...
                    <form action="" method="post" class="card-body">
                        ...
                        <div class="row gx-3">
                            <div class="col-md-6 mb-3">
                                <label for="example-text-input" class="form-label"data-i18n="popoups.future_managment.edit_variation_in_product_managment.btn_addiotainal_term">the name of the term</label>
