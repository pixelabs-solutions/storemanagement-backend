            ...
            <div class="row mt-5">
                ...
                <div class="row">
                    <input class="col-lg-12 border-0 rounded-3 py-3 m-0 p-3 form-control"
                        style="background-color: #EAEAEA" type="text"
                        value="<?php echo $woocommerce_stock_email_recipient_value; ?>" id="emailAddress"
            ...
            <div class="row mt-5 gap-0">
                ...
                <div class="col-md-6">
                    ...
                    <input class="border-0 rounded-2 py-3 m-0 p-3 form-control" style="background-color: #EAEAEA"
                        ...
                        id="outOfStockThreshold" placeholder="10">
                </div>
            </div>
...
<script>
    ...
    function sms_inventory_submit_Form() {
        ...
        let manageStocksValue = document.getElementById('flexSwitchCheckDefault').checked;
        let notifyLowStockValue = document.getElementById('flexSwitchCheckDefault2').checked;
        let notifyNoStockValue = document.getElementById('flexSwitchCheckDefault3').checked;

        if (manageStocksValue == true) {
             manageStocks = "yes";
        } else {
             manageStocks = "no";
        }

        if (notifyLowStockValue == true) {
            notifyLowStock = "yes";
        } else {
            notifyLowStock = "no";
        }
        
        if (notifyNoStockValue == true) {
            notifyNoStock = "yes";
        } else {
            notifyNoStock = "no";
        }
        ...
        var formData = {
            'woocommerce_manage_stock': manageStocks,
            'woocommerce_notify_low_stock': notifyLowStock,
            'woocommerce_notify_no_stock': notifyNoStock,
