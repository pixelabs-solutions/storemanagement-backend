...
>>>>>>> 503942616d3a26e92fc288a182838ee5d158bd78
      ...
      <!-- Navbar -->
      <header class="navbar navbar-expand-md sticky-top d-lg-flex d-print-none sms_mu_header"
         style="background-color: #F2F2F2;">
         <div class="d-flex flex-row w-100 justify-content-between align-items-center px-3 header_row_for_hebrew">
            <button class="navbar-toggler d-none" type="button" data-bs-toggle="collapse" data-bs-target="#navbar-menu"
                  ...
                  <div class="nav-item dropdown">
                     <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle=""
                        ...
                        <span class="avatar rounded-circle avatar-sm"
                           ...
                           <img onclick="FunLogoutProfile()" src="/assets/dist/img/profile.png" height="100%"
                              width="100%" alt="">
                        </span>
                  </div>
