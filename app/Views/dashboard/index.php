        ...
        <div class="card h-100" style="border-radius:20px;">
            <div class="card-body">
                ...
                <div class="row g-2 align-items-center  sms_mu_for_rtl_demo">
                    <div class="col-5">
                        <h4 class="text-primary" data-i18n="dashboard.grid_images_in_last.row_left_data ">For All
                            Products</h4>
                    </div>
                    <div class="col-7 ms-auto text-end">
                        <h4 class="text-muted" data-i18n="dashboard.grid_images_in_last.row_right_data">The best selling
                            products</h4>
                    </div>
                </div>
                <!-- End Header -->
    ...
    <div class="col-lg-5 col-md-5 col-sm-12 mb-2">
        <div class="card h-100" style="border-radius:20px;">
            <div class="card-body">
                ...
                <div class="row g-2 align-items-center sms_mu_for_rtl_demo">
                    <div class="col-auto">
                        <h4 class="text-primary" data-i18n="dashboard.last_table_data.table_data_one_on_left">For All
                            Orders</h4>
                    </div>
                    <div class="col-auto ms-auto">
                        <h4 class="text-muted" data-i18n="dashboard.last_table_data.table_data_one_on_right">Last Orders
                        </h4>
                    </div>
                </div>
                <!-- End Header -->
