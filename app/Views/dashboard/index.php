...
<div class="row g-2 mt-5 mb-5 align-items-center sms_mu_for_rtl">
    ...
    <div class="col-auto btn-list">
        ...
        <a href="?query=last_week" id="last_week" class="btn btn-pill btn-light tab-pane sms_w_date"
            data-i18n="dashboard.tabs.second_tab"> Last Week
        </a>
        <a href="?query=current_month" id="current_month" class="btn btn-pill btn-light tab-pane sms_w_date"
            data-i18n="dashboard.tabs.third_tab"> Last Month
        </a>
        <a href="?query=last_year" id="last_year" class="btn btn-pill btn-light tab-pane sms_w_date"
