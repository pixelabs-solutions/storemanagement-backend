            ...
            <div class="card h-100" style="border-radius:20px;">
                <div class="card-body">
                    ...
                    <div class="row g-2 align-items-center sms_mu_margin">
                        ...
                        <div class="col-auto ms-auto ">
                            <div class="mb-3">
                                <select type="text" class="form-select dropdown-tom-select-style with-input" placeholder="Filter by city" name="city" multiple>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" data-i18n="popoups.static_popoup.date_range.date_heading">Select a Date Range</h5>
                ...
                <div class="modal-body">
                    <div class="row mb-3 align-items-end">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <label for="startDate" data-i18n="popoups.static_popoup.date_range.start_date">Start Date</label>
                            <input id="startDate" class="form-control" type="date" />
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="startDate" data-i18n="popoups.static_popoup.date_range.To_date">To Date</label>
                            <input id="startDate" class="form-control" type="date" />
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-pill btn-info" data-bs-dismiss="modal" data-i18n="popoups.static_popoup.date_range.search">Search</button>
                </div>
            </div>
        </div>
    </div>
