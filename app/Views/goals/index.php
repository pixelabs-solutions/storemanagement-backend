        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Bring in NIS 100,000 in sales </h3>
                    <div class="row">
                        <div class="col-6">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Recruit 250 new customers</h3>
                    <div class="row">
                        <div class="col-7">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">450 page views</h3>
                    <div class="row">
                        <div class="col-6">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Advance 15 positions on Google</h3>
                    <div class="row">
                        <div class="col-7">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Added 15 new keywords</h3>
                    <div class="row">
                        <div class="col-7">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Add 40 new products </h3>
                    <div class="row">
                        <div class="col-8">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">10% increase in average items</h3>
                    <div class="row">
                        <div class="col-6">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">An increase of NIS 150 in the average order</h3>
                    <div class="row">
                        <div class="col-6">
