        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Bring in NIS <?php echo $data[0]['sales_revenue_target']; ?> in sales </h3>
                    <div class="row">
                        <div class="col-6">
                            <p class="text-start">NIS 50,000 was received</p>
                        </div>
                        <div class="col-6">
                            <p class="ms-auto text-end">NIS 50,000 left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                        <div class="progress-bar" style="width: 38%; border-radius:10px;" role="progressbar"
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Recruit <?php echo $data[0]['new_customers_target']; ?> new customers</h3>
                    <div class="row">
                        <div class="col-7">
                            <p class="text-start">150 customers were recruited</p>
                        </div>
                        <div class="col-5">
                            <p class="ms-auto text-end">100 customers left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                        <div class="progress-bar" style="width: 38%; border-radius:10px;" role="progressbar"
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3" ><?php echo $data[0]['new_orders_target']; ?> new orders </h3>
                    <div class="row">
                        <div class="col-6">
                            <p class="text-start">250 were accepted</p>
                        </div>
                        <div class="col-6">
                            <p class="ms-auto text-end">200 left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                        <div class="progress-bar" style="width: 75%; border-radius:10px;" role="progressbar"
                            aria-valuenow="38" aria-valuemin="0" aria-valuemax="100" aria-label="38% Complete">
                            <span>75%</span>
                        </div>
                    </div>
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3"><?php echo $data[0]['page_views_target']; ?> page views</h3>
                    <div class="row">
                        <div class="col-6">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Advance <?php echo $data[0]['google_rankings_target']; ?> positions on Google</h3>
                    <div class="row">
                        <div class="col-7">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Added <?php echo $data[0]['target_keywords']; ?> new keywords</h3>
                    <div class="row">
                        <div class="col-7">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Add <?php echo $data[0]['new_products_target']; ?> new products </h3>
                    <div class="row">
                        <div class="col-8">
                            <p class="text-start">20 products have been added</p>
                        </div>
                        <div class="col-4">
                            <p class="ms-auto text-end">20 products left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                        <div class="progress-bar" style="width: 38%; border-radius:10px;" role="progressbar"
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3"><?php echo $data[0]['avg_order_items_increase_target']; ?>% increase in average items</h3>
                    <div class="row">
                        <div class="col-6">
                            <p class="text-start">rose by 4% </p>
                        </div>
                        <div class="col-6">
                            <p class="ms-auto text-end">6% left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                        <div class="progress-bar" style="width: 38%; border-radius:10px;" role="progressbar"
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">An increase of NIS <?php echo $data[0]['avg_order_value_increase_target']; ?> in the average order</h3>
                    <div class="row">
                        <div class="col-6">
                            <p class="text-start">rose by 0 NIS </p>
                        </div>
                        <div class="col-6">
                            <p class="ms-auto text-end">0 NIS left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                        <div class="progress-bar" style="width: 38%; border-radius:10px;" role="progressbar"
