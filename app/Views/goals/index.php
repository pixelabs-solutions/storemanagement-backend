    ...
    ?>
        ...
        ?>
                    ...
                    <div class="card pt-2 pb-2" style=" border-radius:20px;">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <h3 class="mt-3">Recruit <?php echo $goals_data["new_customers"]['target']; ?> new
                                    customers
                                </h3>
                                <div class="row">
                                    <div class="col-7">
                                    ...
                                    <div class="col-5">
                                        <p class="ms-auto text-end"><?php echo $new_customers_left; ?> customers left
                                        </p>
                                    </div>
                                </div>
                                <div class="progress mb-2" style="height:20px; border-radius:10px;">
                ...
                ?>
                        <div class="card pt-2 pb-2" style=" border-radius:20px;">
                            <!-- Ribbon Start -->
                            <div class="sms_m_ribbon  bg-light text-dark" style="display: none;"
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <h3 class="mt-3"> <?php echo $goals_data["new_orders"]['target']; ?> new orders
                                    </h3>
                                    <div class="row">
                                        <div class="col-6">
                                            <p class="text-start">
                        ...
                        <div class="card pt-2 pb-2" style=" border-radius:20px;">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <h3 class="mt-3">Advance <?php echo $goals_data["google_rankings"]['target']; ?>
                                        positions on
                                        Google
                                    </h3>
                                    <div class="row">
                                    ...
                                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                                        <div class="progress-bar" style="width: 93%; border-radius:10px;"
                        ...
                        <div class="card pt-2 pb-2" style=" border-radius:20px;">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <h3 class="mt-3">Added <?php echo $goals_data["keywords"]['target']; ?> new keywords
                                    </h3>
                                    <div class="row">
                                        <div class="col-7">
                            ...
                            <div class="card pt-2 pb-2" style=" border-radius:20px;">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        ...
                                        <h3 class="mt-3">Add <?php echo $goals_data["new_products"]['target']; ?> new
                                            products
                                        </h3>
                                        <div class="row">
                                            <div class="col-8">
                                            ...
                                            <div class="col-4">
                                                <p class="ms-auto text-end"><?php echo $new_products_left; ?> products
                                                    left
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card pt-2 pb-2" style=" border-radius:20px;">
                                        ...
                                        <div class="card-body">
                                            <div class="text-center">
                                                ...
                                                <h3 class="mt-3">An increase of NIS
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header" style="background-color: #4987D870">
                                            <div class="py-1 rounded-top text-center">
                                                <h3 class="card-title m-0 text-black fs-2 fw-bold">Definitions of goals
                                                    and
                                                    objectives
                                                </h3>
                                            </div>
