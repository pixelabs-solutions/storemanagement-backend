        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Bring in NIS <?php echo $goals_data["orders"]['target']; ?> in sales </h3>
                    <div class="row">
                        <div class="col-6">
                            <p class="text-start">NIS <?php echo $goals_data["orders"]['sales']; ?> was received</p>
                        </div>
                        <div class="col-6">
                            <p class="ms-auto text-end">NIS <?php echo $total_sales_left; ?> left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                        <div class="progress-bar" style="width: <?php echo $total_sales_left_percentage; ?>%; border-radius:10px;" role="progressbar"
                            aria-valuenow="<?php echo $total_sales_left_percentage; ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo $total_sales_left_percentage; ?>% Complete">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Recruit <?php echo $goals_data["new_customers"]['target']; ?> new customers</h3>
                    <div class="row">
                        <div class="col-7">
                            <p class="text-start"><?php echo $goals_data["new_customers"]['customers_count']; ?> customers were recruited</p>
                        </div>
                        <div class="col-5">
                            <p class="ms-auto text-end"><?php echo $new_customers_left; ?> customers left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                        <div class="progress-bar" style="width: <?php echo $new_customers_left_percentage; ?>%; border-radius:10px;" role="progressbar"
                            aria-valuenow="<?php echo $new_customers_left_percentage; ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo $new_customers_left_percentage; ?>% Complete">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3" > <?php echo $goals_data["new_orders"]['target']; ?> new orders </h3>
                    <div class="row">
                        <div class="col-6">
                            <p class="text-start"><?php echo $goals_data["new_orders"]['orders_count']; ?> were accepted</p>
                        </div>
                        <div class="col-6">
                            <p class="ms-auto text-end"><?php echo $new_sales_left; ?> left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                        <div class="progress-bar" style="width: <?php echo $new_sales_left_percentage; ?>%; border-radius:10px;" role="progressbar"
                            aria-valuenow="<?php echo $new_sales_left_percentage; ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo $new_sales_left_percentage; ?>% Complete">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3"> <?php echo $goals_data["page_views"]['target']; ?>  page views</h3>
                    <div class="row">
                        <div class="col-6">
                            <p class="text-start">450 were accepted</p>
                        </div>
                        <div class="col-6">
                            <p class="ms-auto text-end">0 left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                        <div class="progress-bar" style="width: 100%; border-radius:10px;" role="progressbar"
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Advance <?php echo $goals_data["google_rankings"]['target']; ?> positions on Google</h3>
                    <div class="row">
                        <div class="col-7">
                            <p class="text-start">You advanced 8 positions</p>
                        </div>
                        <div class="col-5">
                            <p class="ms-auto text-end">7 more locations left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                        <div class="progress-bar" style="width: 93%; border-radius:10px;" role="progressbar"
                            aria-valuenow="38" aria-valuemin="0" aria-valuemax="100" aria-label="38% Complete">
                            <span>93%</span>
                        </div>
                    </div>
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Added <?php echo $goals_data["keywords"]['target']; ?> new keywords</h3>
                    <div class="row">
                        <div class="col-7">
                            <p class="text-start">Added 8 keywords </p>
                        </div>
                        <div class="col-5">
                            <p class="ms-auto text-end">7 more keywords left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">Add <?php echo $goals_data["new_products"]['target']; ?> new products </h3>
                    <div class="row">
                        <div class="col-8">
                            <p class="text-start"><?php echo $goals_data["new_products"]['products_count']; ?> products have been added</p>
                        </div>
                        <div class="col-4">
                            <p class="ms-auto text-end"><?php echo $new_products_left; ?> products left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                        <div class="progress-bar" style="width: <?php echo $new_products_left_percentage; ?>%; border-radius:10px;" role="progressbar"
                            aria-valuenow="<?php echo $new_products_left_percentage; ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo $new_products_left_percentage; ?>% Complete">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3"><?php echo $goals_data["avg_order_items_increase"]['target']; ?>% increase in average items</h3>
                    <div class="row">
                        <div class="col-6">
                            <p class="text-start">rose by <?php echo $goals_data["avg_order_items_increase"]['rasie_in_average_items']; ?>% </p>
                        </div>
                        <div class="col-6">
                            <p class="ms-auto text-end"><?php echo $avg_order_items_increase_left; ?>% left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                        <div class="progress-bar" style="width: <?php echo $avg_order_items_increase_left_percentage; ?>%; border-radius:10px;" role="progressbar"
                            aria-valuenow="<?php echo $avg_order_items_increase_left_percentage; ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo $avg_order_items_increase_left_percentage; ?>% Complete">
        ...
        <div class="card pt-2 pb-2" style=" border-radius:20px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h3 class="mt-3">An increase of NIS <?php echo $goals_data["avg_order_value_increase"]['target']; ?> in the average order</h3>
                    <div class="row">
                        <div class="col-6">
                            <p class="text-start">rose by <?php echo $goals_data["avg_order_value_increase"]['rasie_in_average_price']; ?> NIS </p>
                        </div>
                        <div class="col-6">
                            <p class="ms-auto text-end"><?php echo $avg_order_value_increase_left; ?> NIS left</p>
                        </div>
                    </div>
                    <div class="progress mb-2" style="height:20px; border-radius:10px;">
                        <div class="progress-bar" style="width: <?php echo $avg_order_value_increase_left_percentage; ?>%; border-radius:10px;" role="progressbar"
                            aria-valuenow="<?php echo $avg_order_value_increase_left_percentage; ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo $avg_order_value_increase_left_percentage; ?>% Complete">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color: #4987D870">
                <div class="py-1 rounded-top text-center">
                    <h3 class="card-title m-0 text-black fs-2 fw-bold">Definitions of goals and objectives</h3>
                </div>
