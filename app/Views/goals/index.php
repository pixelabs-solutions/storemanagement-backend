...
<div class="row mt-5 mb-5 sms_mu_goals_main">
                ...
                <div class="card-body">
                    <div class="text-center">
                        <svg width="44" height="36" viewBox="0 0 44 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4.88889 0.888672C2.19236 0.888672 0 3.08103 0 5.77756V8.222H44V5.77756C44 3.08103 41.8076 0.888672 39.1111 0.888672H4.88889ZM44 15.5553H0V30.222C0 32.9185 2.19236 35.1109 4.88889 35.1109H39.1111C41.8076 35.1109 44 32.9185 44 30.222V15.5553ZM8.55556 25.3331H13.4444C14.1167 25.3331 14.6667 25.8831 14.6667 26.5553C14.6667 27.2276 14.1167 27.7776 13.4444 27.7776H8.55556C7.88333 27.7776 7.33333 27.2276 7.33333 26.5553C7.33333 25.8831 7.88333 25.3331 8.55556 25.3331ZM17.1111 26.5553C17.1111 25.8831 17.6611 25.3331 18.3333 25.3331H28.1111C28.7833 25.3331 29.3333 25.8831 29.3333 26.5553C29.3333 27.2276 28.7833 27.7776 28.1111 27.7776H18.3333C17.6611 27.7776 17.1111 27.2276 17.1111 26.5553Z" fill="#4987D8" />
                        </svg>
                        <h3 class="mt-3 text-nowrap">
                            <span data-i18n="objective.top_section_like_nav.text_hading">
                                Bring in NIS
                            </span> <?php echo $goals_data["orders"]['target']; ?>
                            <span data-i18n="objective.card_one_in_objective.card_title">
                                in sales
                            </span>
                        </h3>
                        <div class="row">
                            <div class="col-6">
                                <p class="text-start text-nowrap">
                                    <span data-i18n="objective.card_one_in_objective.card_one_p_left">
                                        NIS
                                    </span>

                                    <?php echo $goals_data["orders"]['sales']; ?>


                                    <span data-i18n="objective.card_two_in_objective.card_one_p_left">
                                        was received
                                    </span>
                                </p>
                            </div>
                            <div class="col-6">
                                <p class="ms-auto text-end text-nowrap">
                                    ...
                                    <?php echo $total_sales_left; ?>

                                    <span data-i18n="objective.card_one_in_objective.card_tag_p_right">
                                        left
                                    </span>
                        ...
                        <div class="progress mb-2 text-nowrap" style="height:20px; border-radius:10px;">
                            <div class="progress-bar" style="width: <?php echo $total_sales_left_percentage; ?>%; border-radius:10px;" role="progressbar" aria-valuenow="<?php echo $total_sales_left_percentage; ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo $total_sales_left_percentage; ?>% Complete">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <p class="text-start text-nowrap">
                                            ...
                                            <span data-i18n="objective.card_two_in_objective.card_tag_p_right">
                                                customers were recruited
                                            </span>
                                        </p>
                                    </div>
                                    <div class="col-5">
                                        <p class="ms-auto text-end text-nowrap"><?php echo $new_customers_left; ?>
                                            <span data-i18n="objective.card_three_in_objective.card_title">
                                                customers left
                                            </span>
                                        </p>
                                    </div>
                                ...
                                <div class="progress mb-2" style="height:20px; border-radius:10px;">
                                    <div class="progress-bar text-nowrap" style="width: <?php echo $new_customers_left_percentage; ?>%; border-radius:10px;" role="progressbar" aria-valuenow="<?php echo $new_customers_left_percentage; ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo $new_customers_left_percentage; ?>% Complete">
                            ...
                            <div class="card pt-2 pb-2" style=" border-radius:20px;">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <p class="text-start text-nowrap">
                                                    ...
                                                    <span data-i18n="objective.card_three_in_objective.card_tag_p_right">
                                                        were
                                                        accepted
                                                    </span>
                                                </p>
                                            ...
                                            <div class="col-6">
                                                <p class="ms-auto text-end text-nowrap"><?php echo $new_sales_left; ?>
                                                    <span data-i18n="objective.card_one_in_objective.card_tag_p_right">
                                                        left
                                                    </span>
                                                </p>
                                        ...
                                        <div class="progress mb-2 text-nowrap" style="height:20px; border-radius:10px;">
                                            <div class="progress-bar" style="width: <?php echo $new_sales_left_percentage; ?>%; border-radius:10px;" role="progressbar" aria-valuenow="<?php echo $new_sales_left_percentage; ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo $new_sales_left_percentage; ?>% Complete">
                                ...
                                <div class="card pt-2 pb-2" style=" border-radius:20px;">
                                    ...
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <p class="text-start text-nowrap"><span data-i18n="objective.card_four_in_objective.card_one_p_left">
                                                            450 were accepted
                                                        </span></p>
                                                </div>
                                                <div class="col-6">
                                                    <p class="ms-auto text-end text-nowrap" data-i18n="objective.card_one_in_objective.card_tag_p_right">left</p>
                                                </div>
                                            </div>
                                            <div class="progress mb-2" style="height:20px; border-radius:10px;">
                                                <div class="progress-bar nowrap" style="width: 90%; border-radius:10px;" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" aria-label="90% Complete">
                                                    <span>90%</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card pt-2 pb-2" style=" border-radius:20px;">
                                    ...
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <div class="row">
                                                <div class="col-7 ">
                                                    <p class="text-start text-nowrap"><span data-i18n="objective.card_five_in_objective.card_tag_p_right">
                                                            You advanced
                                                        </span> 8
                                                        <span data-i18n="objective.card_six_in_objective.card_title"> positions</span>

                                                    </p>
                                                </div>
                                                <div class="col-5">
                                                    <p class="ms-auto text-end text-nowrap">7 <span data-i18n="objective.card_six_in_objective.card_one_p_left">locations left</span></p>
                                                </div>
                                            </div>
                                            <div class="progress mb-2" style="height:20px; border-radius:10px;">
                                                <div class="progress-bar text-nowrap" style="width: 93%; border-radius:10px;" role="progressbar" aria-valuenow="38" aria-valuemin="0" aria-valuemax="100" aria-label="38% Complete">
                                                    <span>93%</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <h3 class="mt-3 text-nowrap"> <span data-i18n="objective.card_six_in_objective.card_tag_p_right">
                                                    Added
                                                </span><?php //echo $goals_data["keywords"]['target']; 
                                                        ?> <span data-i18n="objective.card_seven_in_objective.card_title">
                                                    new keywords
                                                </span>
                                            </h3>
                                            <div class="row">
                                                <div class="col-7">
                                                    <p class="text-start text-nowrap"><span data-i18n="objective.card_six_in_objective.card_tag_p_right">
                                                            Added
                                                            z</span> 8 <span data-i18n="objective.card_seven_in_objective.card_title">
                                                            new keywords
                                                        </span> </p>
                                                </div>
                                                <div class="col-5">
                                                    <p class="ms-auto text-end text-nowrap ">7 <span data-i18n="objective.card_seven_in_objective.card_one_p_left">
                                                            keywords left
                                                        </span></p>
                                                </div>
                                            </div>
                                            <div class="progress mb-2" style="height:20px; border-radius:10px;">
                                                <div class="progress-bar" style="width: 50%; border-radius:10px;" role="progressbar" aria-valuenow="38" aria-valuemin="0" aria-valuemax="100" aria-label="38% Complete text-nowrap">
                                                    <span>50%</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card pt-2 pb-2" style=" border-radius:20px;">
                                        ...
                                        <div class="card-body">
                                            <div class="text-center">
                                                ...
                                                <h3 class="mt-3 text-nowrap"><span data-i18n="objective.card_seven_in_objective.card_tag_p_right">Add</span> <?php echo $goals_data["new_products"]['target']; ?><span data-i18n="objective.card_eight_in_objective.card_title"> new
                                                        products</span>
                                                </h3>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <p class="text-start text-nowrap">
                                                            ...
                                                            <span data-i18n="objective.card_eight_in_objective.card_title">
                                                                products
                                                                have been added
                                                            </span>
                                                        </p>
                                                    ...
                                                    <div class="col-6">
                                                        <p class="ms-auto text-center text-nowrap"><?php echo $new_products_left; ?>
                                                            <span data-i18n="objective.card_eight_in_objective.card_one_p_left">
                                                                products
                                                                left
                                                            </span>
                                                        </p>
                                                ...
                                                <div class="progress mb-2" style="height:20px; border-radius:10px;">
                                                    <div class="progress-bar" style="width: <?php echo $new_products_left_percentage; ?>%; border-radius:10px;" role="progressbar" aria-valuenow="<?php echo $new_products_left_percentage; ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo $new_products_left_percentage; ?>% Complete">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4">
                                                                <span>
                                                                    ...
                                                                    <span data-i18n="objective.card_one_in_objective.card_tag_p_right"> >left</span>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="progress my-3 " style="height:20px; border-radius:10px;">
                                                            <div class="progress-bar" style="width: <?php echo $avg_order_items_increase_left_percentage; ?>%; border-radius:10px;" role="progressbar" aria-valuenow="<?php echo $avg_order_items_increase_left_percentage; ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo $avg_order_items_increase_left_percentage; ?>% Complete">
                                                    ...
                                                    <div class="card pt-2 pb-2" style=" border-radius:20px;">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="text-center">
                                                                ...
                                                                <h3 class="mt-3 text-nowrap"><span data-i18n="objective.card_nine_in_objective.card_tag_p_right">
                                                                        An increase of NIS
                                                                    </span>
                                                                ...
                                                                <div class="row text-center ">
                                                                    ...
                                                                    <div class="progress mb-2 " style="height:20px; border-radius:10px;">
                                                                        <div class="progress-bar text-nowrap" style="width: <?php echo $avg_order_value_increase_left_percentage; ?>%; border-radius:10px;" role="progressbar" aria-valuenow="<?php echo $avg_order_value_increase_left_percentage; ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo $avg_order_value_increase_left_percentage; ?>% Complete">
