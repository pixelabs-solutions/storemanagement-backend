            ...
            <div class="card pt-2 pb-2" style=" border-radius:20px;">
                ...
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <h3 class="mt-3 ">
                            <span data-i18n="objective.card_one_in_objective.card_title_bring">
                                Bring in
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-5">
                                        <p class="ms-auto text-end "><?php echo $new_customers_left; ?>
                                ...
                                <div class="progress mb-2" style="height:20px; border-radius:10px;">
                                    <div class="progress-bar " style="width: <?php echo $new_customers_left_percentage; ?>%; border-radius:10px;" role="progressbar" aria-valuenow="<?php echo $new_customers_left_percentage; ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo $new_customers_left_percentage; ?>% Complete">
                            ...
                            <div class="card pt-2 pb-2" style=" border-radius:20px;">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        ...
                                        <h3 class="mt-3 "> <?php echo $goals_data["new_orders"]['target']; ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <p class="ms-auto text-end "><?php echo $new_sales_left; ?>
                                                    <span data-i18n="objective.card_one_in_objective.card_tag_p_right">
                                                        left
                                                    </span>
                                                </p>
                                ...
                                <div class="card pt-2 pb-2" style=" border-radius:20px;">
                                    ...
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <h3 class="mt-3 "> <?php //echo $goals_data["page_views"]['target']; 
                                                                            ?>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <p class="text-start "><span data-i18n="objective.card_four_in_objective.card_one_p_left">
                                                            450 were accepted
                                                        </span></p>
                                                </div>
                                                <div class="col-6">
                                                    <p class="ms-auto text-end " data-i18n="objective.card_one_in_objective.card_tag_p_right">left</p>
                                                </div>
                                            </div>
                                            <div class="progress mb-2" style="height:20px; border-radius:10px;">
                                ...
                                <div class="card pt-2 pb-2" style=" border-radius:20px;">
                                    ...
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <div class="row">
                                                <div class="col-7 ">
                                                    <p class="text-start "><span data-i18n="objective.card_five_in_objective.card_tag_p_right">
                                                            You advanced
                                                        </span> 8
                                                ...
                                                <div class="col-5">
                                                    <p class="ms-auto text-end ">7 <span data-i18n="objective.card_six_in_objective.card_one_p_left">locations left</span></p>
                                                </div>
                                            </div>
                                            <div class="progress mb-2" style="height:20px; border-radius:10px;">
                                                <div class="progress-bar " style="width: 93%; border-radius:10px;" role="progressbar" aria-valuenow="38" aria-valuemin="0" aria-valuemax="100" aria-label="38% Complete">
                                                    <span>93%</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card pt-2 pb-2" style=" border-radius:20px;">
                                    ...
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <h3 class="mt-3 "> <span data-i18n="objective.card_six_in_objective.card_tag_p_right">
                                                    Added
                                            ...
                                            <div class="row">
                                                <div class="col-7">
                                                    <p class="text-start "><span data-i18n="objective.card_six_in_objective.card_tag_p_right">
                                                            Added
                                                ...
                                                <div class="col-5">
                                                    <p class="ms-auto text-end  ">7 <span data-i18n="objective.card_seven_in_objective.card_one_p_left">
                                                            keywords left
                                                        </span></p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card pt-2 pb-2" style=" border-radius:20px;">
                                        ...
                                        <div class="card-body">
                                            <div class="text-center">
                                                ...
                                                <h3 class="mt-3 "><span data-i18n="objective.card_seven_in_objective.card_tag_p_right">Add</span> <?php echo $goals_data["new_products"]['target']; ?> <span data-i18n="objective.card_eight_in_objective.card_title">  new
                                                        products</span>
                                                </h3>
                                                <div class="row">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="ms-auto text-center "><?php echo $new_products_left; ?>
                                        ...
                                        ?> <!-- Bring in NIS Card Start -->
                                            ...
                                            ?> <!-- Bring in NIS Card Start -->
                                                ...
                                                ?> <!-- Bring in NIS Card Start -->
                                                    ...
                                                    <div class="card pt-2 pb-2" style=" border-radius:20px;">
                                                        <!-- Ribbon Start -->
                                                        <div class="sms_m_ribbon  bg-light text-dark " style="display: none; ">Well done
                                                        </div>
                                                        <!-- Ribbon End -->
                                                        <div class="card-body">
                                                            <div class="text-center">
                                                                ...
                                                                <h3 class="mt-3 "><span data-i18n="objective.card_nine_in_objective.card_tag_p_right">
                                                                        An increase of 

                                                                    </span>
                                                                    <?php echo $goals_data["avg_order_value_increase"]['target']; ?>
                                                                    <span data-i18n="objective.card_nine_in_objective.card_title">
                                                                    <?php echo CURRENT_CURRENCY;?> in the average order
                                                                    </span>
                                                                </h3>
                                                                <div class="row text-center ">
                                                                    ...
                                                                    <div class="progress mb-2 " style="height:20px; border-radius:10px;">
                                                                        <div class="progress-bar " style="width: <?php echo $avg_order_value_increase_left_percentage; ?>%; border-radius:10px;" role="progressbar" aria-valuenow="<?php echo $avg_order_value_increase_left_percentage; ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo $avg_order_value_increase_left_percentage; ?>% Complete">
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header" style="background-color: #4987D870">
                                                                    <div class="py-1 rounded-top text-center">
                                                                        <h3 class="card-title m-0 text-black fs-2 fw-bold " data-i18n="popoups.objective_popoup.heading">Definitions of goals and objectives
                                                                        </h3>
                                                                    </div>
