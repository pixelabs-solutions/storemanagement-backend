...
<!--delete modal  -->
<div class="modal modal-blur fade" id="sms_category_w_delete_modal" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content p-3 ">
      ...
      <div class="d-flex justify-content-between col-6 m-auto">
        <button type="button" class="btn Sms_mu_for_Eng  cancel-btn sms_modal_cancel_btn" data-dismiss="modal" style="background-color:#afcaee" id="sms_mu_Cancel">Cancel</button>
        <button type="button" class="btn Sms_mu_for_hebrew cancel-btn sms_modal_cancel_btn" data-dismiss="modal" style="background-color:#afcaee" id="sms_mu_Cancel">לְבַטֵל</button>
        <button type="button" class="btn btn-danger Sms_mu_for_Eng delete-button" onclick="deleteCategory('<?php echo $category['id']; ?>')">Delete</button>
        <button type="button" class="btn btn-danger Sms_mu_for_hebrew" onclick="deleteCategory('<?php echo $category['id']; ?>')">לִמְחוֹק</button>
      </div>
    </div>
  </div>
</div>
