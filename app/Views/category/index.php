...
<script>
  ...
  function openModal(modalId, categoryData, parentCategoriesData) {
    ...
    var modal1 = document.getElementById('sms_category_w_delete_modal');
    $(modal1).modal('show');
  ...
  document.getElementById('deleteIcon').addEventListener('click', openModal);
  document.getElementById('EditPopoup').addEventListener('click', openModal2);
