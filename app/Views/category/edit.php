            ...
            <div class="col-12 col-md-10">
                <div class="">
                                        ...
                                        <div class="mb-3 p-2 col-12 rounded-3 d-flex align-items-center justify-content-between " style="background-color: #EAEAEA">
                                            ...
                                            <div class="sms_a_edit_category">
                                                ...
                                                <label for="sms_img_ctg">
                                                    ...
                                                    <span class="fs-4 text-dark fw-bold"> Change image</span>
                                                </label>
                                            </div>
                                            <div class="col-auto">
                    ...
                    <div class="text-center mt-2 p-2  ">
                        <button type="button" class="btn btn-primary col-12 col-md-12 rounded-4 py-3" style="background-color:#4987D870; " onclick="function_submit_ctg()">To
                            update
                            the term click here
                            +</button>
                    </div>
