        ...
        <div class="col-12 col-md-10">
            <div class="">
                ...
                <form action="" method="post" class="card-body">
                    ...
                    <div class="row gx-3">
                        <div class="col-md-6 mb-3">
                            <label for="example-text-input fs-2 fw-bold" class="form-label fw-bold"
                                data-i18n="popoups.add_new_catageory.popoup_in_catagory.heading">The name of
                                the
                                category</label>
                            <input type="text" class="form-control rounded-3 p-3 fw-bold" id="sms_mu_key_category"
                                style="background-color: #EAEAEA" placeholder="Name Of Category">

                            <input type="hidden" id="sms_mu_id_category">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="example-select fs-3 fw-bold" class="form-label fw-bold"
                                data-i18n="popoups.add_new_catageory.popoup_in_catagory.label_parent_ct">Parent category
                            </label>
                            <div
                                ...
                                <div class="col-md-12 rounded-4 bg-transparent h-100 ">
                                    <select id="sms_mu_select_category_pop" class="form-select"
                                ...
                                <div class='gx-3'>
                                    <div class="mb-3 p-2 col-12 rounded-3 d-flex align-items-center justify-content-between "
                                        ...
                                        <div class="sms_a_edit_category">
                                            <input type="file" id="sms_img_ctg" accept="image/*"
                                        ...
                                        <div class="col-auto">
                                            <span class="avatar avatar-md">
                                                <img src="https://via.placeholder.com/100" alt="Avatar Image"
                                                    id="edit_category_image_placeholder">
                                            </span>
                                        </div>
                    ...
                    <div class="modal-body text-center py-4 sms_a_add_regular_pop" id="sms_editForm_success_message"
                        style="display: none;">
                        <!-- Close icon -->
                    ...
                    <div class="modal-body text-center py-4 sms_a_add_regular_pop" id="sms_add_editForm_error_message"
                        style="display: none;">
                        <!-- Close icon -->
                        <button type="button" class="btn-close" aria-label="Close"
                            onclick="Sms_mu_close_error()"></button>
                        <!-- SVG icon -->
                ...
                <div class="text-center mt-2 p-2  ">
                    <button type="button" class="btn btn-primary col-12 col-md-12 rounded-4 py-3" id="submit_for_edit"
                        data-i18n="popoups.add_new_catageory.popoup_in_catagory.catageory_btn2"
                        onclick="submit_edit_ctg_form()">To Update the Category click here +</button>
                </div>
            </div>
        </div>
    </div>
    ...
    function submit_edit_ctg_form() {
        ...
        Promise.all(
            ...
            .then(base64Strings => {
                ...
                document.getElementById('Edit_POPOUP_header').style.overflow = 'hidden';
