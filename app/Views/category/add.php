    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-10">
            <div class="">
                    ...
                    <div class="row gx-3">
                        <div class="col-md-6 mb-3">
                            <label for="example-text-input fs-2 fw-bold" class="form-label fw-bold"
                                data-i18n="popoups.add_new_catageory.popoup_in_catagory.heading">The name of the
                                category</label>
                            ...
                            <div class="col-12 col-md-12 p-0 " id="sms_a_dynamic-input-container">
                                <div class=" rounded">
                                    <h3 class="card-title text-black fs-4 fw-bold"
                                        data-i18n="popoups.add_new_catageory.popoup_in_catagory.label_up_img">
                                        ...
                                        <label class="form-label">
                                            <div class="sms_a_add_new_category">
                                                ...
                                                <label for="sms_mu_img_add_ctg">
                                                    <i class="bi bi-image text-black"></i><svg width="20" height="20"
                                                    ...
                                                    <p
                                                        data-i18n="popoups.add_new_catageory.popoup_in_catagory.select_img_text">
                ...
                <div class="modal-body text-center py-4 sms_a_add_category_pop" id="sms_addForm_category_error_message"
                    style="display: none;">
                    <!-- Close icon -->
                    <button type="button" class="btn-close" aria-label="Close"
                        onclick="Sms_mu_close_add_form_error()"></button>
                    <!-- SVG icon -->
    ...
    function function_of_Edit() {
        ...
        readFileAsBase64(imageInput.files[0])
            .then(base64String => {
                ...
                const AddsubmitButton = document.getElementById("disable_for_submit");
