        ...
        <div class="col-12 bg-white shadow p-5 rounded-3" >
          ...
          <form action="/authentication/login" method="POST" autocomplete="off" novalidate>
            <div class="mb-3">
              ...
              <input type="email" name="email" class="form-control" placeholder="Enter Your Name" autocomplete="off">
            </div>
            <div class="mb-3">
              <label class="form-label">Last Name</label>
              <input type="email" name="email" class="form-control" placeholder="Enter Your Last Name" autocomplete="off">
            </div>
            <div class="mb-3">
              <label class="form-label">Phoone Number</label>
              <input type="email" name="email" class="form-control" placeholder="Enter Your Phone Number" autocomplete="off">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="email" name="email" class="form-control" placeholder="Enter Your Bussines Name" autocomplete="off">
            </div>
