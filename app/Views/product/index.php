        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center d-grid gap-2">
                    <div class="mb-3">
                    <button id="importBtn" class="btn btn-primary btn-lg" onclick="importData()">Import</button>
                ...
                <div class="sms_mu_btns_filter d-flex w-100 align-items-baseline bg-white  rounded-top-4 fixed"
                    ...
                    <div class="d-flex flex-row gap-3 text-center w-100 justify-content-end" style="margin: 10px 0;">
                        ...
                        <div id="popup" class="popup">
                            ...
                            <div class="popup-content">
                                <h3 class="text-center"
                                    data-i18n="product_managment.product_search.filter_inventory_btn">Filter By
                                    Inventory</h3>
                                <span class="close">&times;</span>
                        ...
                        <div id="popups" class="popup">
                            <div class="popup-content">
                                <h3 class="text-center"
                                    data-i18n="product_managment.product_search.filter_catageary_btn">Filter By Category
                                    and Product Name</h3>
                                <span class="close">&times;</span>
                                <div class="mb-3"
                        ...
                        <div id="popups" class="popup">
                            <div class="popup-content">
                                <h3 class="text-center"
                                    data-i18n="product_managment.product_search.filter_catageary_btn">Filter By Product
                                    Name</h3>
                                <span class="close">&times;</span>
                                <div class="-5"
                                    style="background-color: #eaeaea; position: relative; border-radius:12px; height:55px;">
...
// });
 ...
 <script>
        ...
        function importData() {
            // Fetch API endpoint for import
            fetch('/products/import', {
                method: 'POST',
                body: new FormData(document.getElementById('formFile')),
            })
            .then(response => {
                // Handle response
    ...
    .then(blob => {
        ...
        // Click the anchor to trigger the file download
        a.click();
