                                ...
                                <div class="table-responsive">
                                    <table class="table table-vcenter card-table w-100">
                                        <tr class="t-head gap-2 rounded-4 py-2" style="background-color: rgba(73, 135, 216, 0.44);">
                                            ...
                                            <th class=" sms_edit_product_variations_a" data-i18n="popoups.future_managment.edit_variation_in_product_managment.th_in_variation.th_term">
                                                Variation Name</th>
                                            <th class="sms_edit_product_variations_a" data-i18n="popoups.future_managment.edit_variation_in_product_managment.th_in_variation.th_price">
                                                Variation Price
                                            </th>
                                            <th class="sms_edit_product_variations_a" data-i18n="popoups.future_managment.edit_variation_in_product_managment.th_in_variation.th_inventory">
                                                Variation
                                                inventory</th>
