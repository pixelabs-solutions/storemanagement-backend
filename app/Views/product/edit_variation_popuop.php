        ...
        <div class="">
          ...
          <form action="" method="post" class="card-body">
            ...
            <div class="row gx-3">
              <div class="col-md-6 mb-3">
                <label for="example-text-input fs-2 fw-bold" class="form-label fw-bold">Name of the
                  Variation</label>
                <input type="text" read class="form-control rounded-3 p-3" id="sms_mu_name_variation"
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="number" class="form-control rounded-3 p-3" id="sms_mu_price_variation"
                  style="background-color: #EAEAEA" placeholder="Pink">
              </div>
            </div>
            <div class="col-md-12 mb-3">
              ...
              <input type="number" class="form-control rounded-3 p-3" id="sms_mu_inventory_variation"
                style="background-color: #EAEAEA" placeholder="Pink">
            </div>
        </div>
        </form>
...
<script>
  ...
  function fun_edit_variation() {
    ...
    let disbalebutton = document.getElementById("sms_button_disabless");
    disbalebutton.disabled = true;
