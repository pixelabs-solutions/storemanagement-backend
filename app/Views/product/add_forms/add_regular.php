                    ...
                    <form class="card-body add_regular_product_form">
                        ...
                        <div class="row gx-3">
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="sms_a_custom_file_input">
                                    <input type="file" id="sms_mu_img" accept="image/*"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="sms_a_custom_file_input">
                                    <input type="file" id="sms_mu_photo" accept="image/*"
                        ...
                        <div>
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Leave a comment here" id="sms_mu_textarea"
