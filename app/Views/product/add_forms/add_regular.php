                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="sms_a_custom_file_input">
                                ...
                                <label for="sms_mu_img" id="sms_mu_img_label">
                                    ...
                                    </i> <p data-i18n="popoups.add_new_product_popoup.image_upload">Choose a picture</p>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="sms_a_custom_file_input">
                                ...
                                <label for="sms_mu_photo" id="sms_mu_photo_label">
                                    ...
                                    </i><p data-i18n="popoups.add_new_product_popoup.image_upload_text">Choose a picture</p>
                                </label>
                            </div>
                        </div>
                    </div>
