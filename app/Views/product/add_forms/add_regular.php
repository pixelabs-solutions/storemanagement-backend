    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-10">
            <div class="">
                ...
                <form class="card-body add_regular_product_form">
                    ...
                    <div class="row gx-3">
                        <div class="col-md-6 mb-3">
                            <label for="example-text-input fs-2 fw-bold" class="form-label fw-bold"
                                ...
                                Name</label>
                            <input type="text" class="form-control rounded-3 p-3 fw-bold" id="sms_product_name"
                                style="background-color: #EAEAEA" placeholder="E.g:Blue Gucci bag">
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="-5"
                                ...
                                <div class="col-md-12 rounded-4 bg-transparent h-100 ">
                                    <select id="category_in_product_normal_product" multiple
                    ...
                    <div class="row gx-3">
                        <div class="col-md-6 mb-4">
                            <label class="form-label" data-i18n="popoups.add_new_product_popoup.image_upload">Upload a
                                product image</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label" data-i18n="popoups.add_new_product_popoup.gallery_upload">Upload a
                                photo gallery</label>
                            <div class="sms_a_custom_file_input">
                                <input type="file" id="sms_mu_photo" accept="image/*" style="background-color:#FFFFFF;"
                                    multiple>
                    ...
                    <div class="row gx-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control rounded-3 p-3 fw-bold" id="sms_mu_Normal"
                                style="background-color: #EAEAEA" placeholder="Normal Price"
                                onchange="Sms_mu_function_least()">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="sms_mu_sale" class="form-label fw-bold">Sale price (optional)</label>
                            <input type="number" class="form-control rounded-3 p-3 fw-bold" id="sms_mu_sale"
                    ...
                    <div>
                        ...
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Brief Description" id="sms_mu_textarea"
                ...
                <div class="modal-body text-center py-4 sms_a_add_regular_pop" id="sms_add_regular_success_message"
                    style="display: none;">
                    <!-- Close icon -->
                ...
                <div class="modal-body text-center py-4 sms_a_add_regular_pop" id="sms_add_regular_error_message"
                    style="display: none;">
                    <!-- Close icon -->
            ...
            <button class="btn Sms_mu_for_hebrew btn-primary col-12 rounded-4 py-3" id="disable_regular"
                onclick="fun()">להוספת המוצר לחץ כאן +</button>
            <button class="btn btn-primary col-12 rounded-4 py-3 Sms_mu_for_Eng" id="disable_regular"
                onclick="fun()">Add Product</button>
        </div>
    </div>
</div>
...
<script>
    ...
    function fun() {
        ...
        let files = [imgInput.files[0]];
        // Loop through the files in photoInput and push them into the files array
